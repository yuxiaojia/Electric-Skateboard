...
#define TASK_ESC_PRIORITY       (configMAX_PRIORITIES - 3)
#define TASK_STATUS_LED_PRIORITY    (configMAX_PRIORITIES - 2)
...
//           " ********\r\n\n");
    ...
    esc_data_q = xQueueCreate(1,sizeof(esc_data_t));
