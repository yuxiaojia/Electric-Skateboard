...
* 	        	Used to act as a remote controller
*
...
#define TASK_ROTARY_ENCODER_PRIORITY    (configMAX_PRIORITIES - 2)
#define TASK_SPEED_LED_PRIORITY    (configMAX_PRIORITIES -3)
...
#define TASK_CAPSENSE_NAME           ("Capsense Task")

/* Stack sized used for task */
#define TASK_BLE_STACK_SIZE         (configMINIMAL_STACK_SIZE*8)
#define TASK_STATUS_LED_STACK_SIZE  (configMINIMAL_STACK_SIZE)
#define TASK_SPEED_LED_STACK_SIZE  (configMINIMAL_STACK_SIZE*8)
...
#define TASK_ROTARY_STACK_SIZE         (configMINIMAL_STACK_SIZE*8)
...
// https://community.infineon.com/t5/ModusToolbox-Blog/Task-Aware-Debugging/ba-p/247054
...
//                                     sizeof(status_led_data_t));
	...
	rtos_api_result |= xTaskCreate(
									task_speed_led,
									"ECE453 SPEED TASK",
									TASK_SPEED_LED_STACK_SIZE,
									NULL,
									TASK_SPEED_LED_PRIORITY,
									NULL);
...
//                                   TASK_BATTERY_PRIORITY, NULL);
    ...
    // the status led is a dev board thing
...
//									256,
//									NULL,
//									TASK_STATUS_LED_PRIORITY,
//									NULL);


	rtos_api_result |= xTaskCreate(task_capsense, TASK_CAPSENSE_NAME, 10*TASK_CAPSENSE_STACK_SIZE, NULL, TASK_CAPSENSE_PRIORITY, NULL);

	    rtos_api_result |= xTaskCreate(task_rotary_encoder,
										"ECE453 ROTARY TASK",
										TASK_ROTARY_STACK_SIZE,
										NULL,
										TASK_ROTARY_ENCODER_PRIORITY,
										NULL);
